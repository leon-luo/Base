...
macro InsertFileHeaderEN(hbuf, ln, name_str, content_str)
{
	...
	curr_line = InsertSection(hbuf, curr_line, "external function prototypes")
	...
	curr_line = InsertSection(hbuf, curr_line, "class")
	curr_line = InsertSection(hbuf, curr_line, "internal function prototypes")
